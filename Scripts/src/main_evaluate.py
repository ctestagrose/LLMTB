...
import os
import glob
from eval_model_dist import evaluate
import random
...
def parse_arguments():
    ...
    with open('Parameters/evaluate_inputs.json', 'r') as f:
...
if __name__ == '__main__':
    ...
    for antibiotic in antibiotics:
        ...
        evaluate(zipped_data, args, sequence_processor, tokenizer_manager, gene_manager, mode="Evaluate")